...
from fastsurfer_inference.fastsurfer_inference import Fastsurfer_inference


class Fastsurfer_inferenceTests(TestCase):
    """
    Test Fastsurfer_inference.
    """
    def setUp(self):
        self.app = Fastsurfer_inference()
